git clone https://github.com/AgoricBot/PlaygroundVat.git
cd PlaygroundVat
git remote add upstream https://github.com/Agoric/PlaygroundVat.git
git remote set-url origin https://AgoricBot:$GITHUB_TOKEN@github.com/AgoricBot/PlaygroundVat.git
git fetch upstream
git checkout master
...
if [ "$files_changed" = true ] ; then
  ...
  hub pull-request --no-edit --base Agoric/PlaygroundVat:master
fi
